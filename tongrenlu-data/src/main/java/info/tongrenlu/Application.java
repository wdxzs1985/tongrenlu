...
public class Application {
    ...
    public DataSource oracleDataSource() {
        ...
        dataSource.setUrl("jdbc:oracle:thin:@(DESCRIPTION=(LOAD_BALANCE=on)(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=local.database) (PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=xe)))");
    ...
    public DataSource mysqlDataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://local.database/tongrenlu?useUnicode=yes&characterEncoding=UTF-8&autoReconnectForPools=true");
