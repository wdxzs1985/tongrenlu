...
public class AdminUserController {
    ...
    @ResponseBody
    public Map<String, Object> doPostRoleEditor(final Integer userId, final Integer role, final Locale locale) {
    ...
    public Map<String, Object> doPostAuthFile(@PathVariable final Integer userId,
        ...
        if (ArrayUtils.isNotEmpty(uploads)) {
            for (final MultipartFile upload : uploads) {
                ...
                authFileBean = this.libraryService.saveAuthFile(upload, authFileBean, fileModel, locale);
