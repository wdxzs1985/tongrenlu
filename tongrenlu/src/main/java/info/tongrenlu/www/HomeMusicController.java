...
public class HomeMusicController {
    ...
    public String doGetViewByArticleId(@PathVariable final Integer articleId,
        ...
        if (isOwner) {
            ...
            if (!musicBean.isFree()) {
                final List<Map<String, Object>> playlist = this.musicService.getPlaylist(articleId, loginUser);
    ...
    public Map<String, Object> doPostAddToLibrary(@PathVariable final Integer articleId,
                                                  ...
                                                  final Locale locale) {
        final Map<String, Object> model = new HashMap<>();
        final boolean result = this.musicService.addToLibrary(articleId, loginUser, model, locale);
