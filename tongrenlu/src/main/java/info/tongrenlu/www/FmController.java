...
public class FmController {
    ...
    @ResponseBody
    public Map<String, Object> musicSearch(
                                           @RequestParam(value = "p", defaultValue = "0") final Integer pageNumber,
    ...
    @ResponseBody
    public Map<String, Object> doGetMusic(
    ...
    @ResponseBody
    public Map<String, Object> doGetLibrary(
                                            @RequestParam(value = "p", defaultValue = "1") final Integer pageNumber,
                                            @ModelAttribute("LOGIN_USER") final UserBean loginUser) {
        final Map<String, Object> model = new HashMap<String, Object>();
