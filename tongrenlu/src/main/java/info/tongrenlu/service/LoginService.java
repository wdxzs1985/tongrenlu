...
public class LoginService {
    ...
    @Transactional
    public UserBean doSignIn(final UserBean inputUser, final String userAgent,
    ...
    public UserBean doAutoLogin(final String fingerprint, final String userAgent) {
        UserBean loginUser = this.userManager.getByFingerprint(fingerprint,
                                                               userAgent);
        if (loginUser != null) {
            this.updateFingerprint(loginUser, userAgent);
        }
    ...
    private void updateFingerprint(final UserBean loginUser,
