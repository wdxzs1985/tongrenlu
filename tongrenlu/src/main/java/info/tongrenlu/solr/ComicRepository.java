...
@Repository
public class ComicRepository extends
        SimpleSolrRepository<ComicDocument, String> {

    @Autowired
    public ComicRepository(final SolrTemplate solrTemplate) {
        super(solrTemplate);
    }

    public Page<ComicDocument> findComic(final List<String> queries,
