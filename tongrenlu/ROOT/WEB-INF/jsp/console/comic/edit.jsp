...
<html>
<head>
<title>博丽神社 / 同人志 / <c:out value="${articleBean.title}" default=""/></title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="<c:url value="/console/comic/${articleBean.articleId}"/>" method="POST" enctype="multipart/form-data" class="">
            <div class="row">
