...
<html>
<head>
<title><fmt:message key="app.name"/> / 博丽神社 > 我投稿的音乐</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-4 col-md-8 col-lg-offset-3 col-lg-9">
                    <form id="search-form" action="<c:url value="/console/music"/>" class="">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-9">
                <ul class="breadcrumb ">
                    ...
                    <li class="active">我投稿的音乐</li>
                </ul>
                <ul class="media-list cover-list">
                    <c:forEach items="${paginateSupport.items}" var="articleBean">
                        <li class="media">
                            <a href="<c:url value="/console/music/${articleBean.articleId}"/>" class="pull-left thumbnail">
                                    <img class="" src="<%= FILE_PATH %>/${articleBean.articleId}/cover_90.jpg?cache=<%= CURRENT_TIME %>" style="">
                            </a>
                            <div class="pull-right">
                                <div class="btn-group">
                                    <a href="<c:url value="/music/${articleBean.articleId}"/>" target="_blank" class="btn btn-default">预览</a>
                                    <a href="<c:url value="/console/music/${articleBean.articleId}/delete"/>" class="btn btn-danger btn-confirm">删除</a>
                                </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    ...
                                    <a class="" href="<c:url value="/console/music/${articleBean.articleId}"/>"><c:out value="${articleBean.title}"/></a>
                                </div>
                ...
                <ul class="pagination visible-xs visible-sm clearfix">
                    ...
                    <li class="<c:if test="${paginateSupport.page eq status.count}">active</c:if>">
                        <a href="<c:url value="/console/music?page=${status.count}&q=${searchQuery}"/>">
...
$(function() {
    $("#jpaginate").paginate({
        ...
        onChange                : function (currval){
            window.location.href = '<c:url value="/console/music?q=${searchQuery}"/>&page=' + currval;
            return false;
        }
    });
