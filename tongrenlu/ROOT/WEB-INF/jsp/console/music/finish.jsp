...
<html>
<head>
    <title><fmt:message key="app.console"/> / <fmt:message key="app.music"/> / <fmt:message key="console.input.finish"/></title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-lg-9">
                ...
                <div>
                    <a href="<c:url value="/console/music"/>" class="btn btn-default">
                        <span>返回列表</span>
                    </a>
                    <a href="<c:url value="/console/music/input"/>" class="btn btn-primary">
                        <span>继续投稿</span>
                    </a>
                    <c:if test="${login_user.adminFlg eq '1'}">
                        <a href="<c:url value="/admin/music"/>" class="btn btn-danger">
                            <span>去审核</span>
                        </a>
                    </c:if>
                </div>
