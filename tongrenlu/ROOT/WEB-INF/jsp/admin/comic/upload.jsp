...
<html>
<head>
<title>博丽神社 / 同人志审核 / <c:out value="${articleBean.title}"/> / 上传文件</title>
...
<div class="container">
    ...
    <form id="fileupload" action="<c:url value="/admin/comic/${articleBean.articleId}/file"/>" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-actions">
        <a class="btn btn-default pull-left" href="<c:url value="/admin/comic"/>">
            <i class="glyphicon glyphicon-arrow-left"></i> <span>返回列表</span>
        </a>
        <a class="btn btn-primary pull-right" href="<c:url value="/admin/comic/${articleBean.articleId}/sort"/>">
...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        url: '<c:url value="/admin/comic/${articleBean.articleId}/file"/>'
    });
