        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-4 col-md-8 col-lg-offset-3 col-lg-9">
		            <form id="search-form" action="<c:url value="/admin/comic"/>" class="">
            ...
            <div class="col-md-8 col-lg-9">
                ...
                <ul class="media-list cover-list">
                    <c:forEach items="${paginateSupport.items}" var="articleBean">
                        <li class="media <c:if test="${articleBean.redFlg eq '1'}">red</c:if>">
                            <a href="<c:url value="/admin/comic/${articleBean.articleId}"/>" class="pull-left thumbnail">
                                <img class="media-object" src="<%= FILE_PATH %>/${articleBean.articleId}/cover_90.jpg" >
                            </a>
                            <div class="pull-right">
                                <div class="btn-group">
                                    <a href="<c:url value="/admin/comic/${articleBean.articleId}/upload"/>" class="btn btn-danger">上传漫画</a>
                                </div>
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    ...
                                    <a class="" href="<c:url value="/admin/comic/${articleBean.articleId}"/>"><c:out value="${articleBean.title}"/></a>
                                </div>
                ...
                <ul class="pagination visible-xs visible-sm clearfix">
                    ...
                    <li class="<c:if test="${paginateSupport.page eq status.count}">active</c:if>">
                        <a href="<c:url value="/admin/comic?page=${status.count}&q=${searchQuery}"/>">
...
$(function() {
    $("#jpaginate").paginate({
        ...
        onChange                : function (currval){
            window.location.href = '<c:url value="/admin/comic?q=${searchQuery}"/>&page=' + currval;
            return false;
        }
    });
});
