...
<html>
<head>
<title>博丽神社 / 音乐审核 / <c:out value="${articleBean.title}"/> / 文件排序</title>
...
<div class="container">
    ...
    <form action="<c:url value="/admin/music/${articleBean.articleId}/booklet/sort"/>" method="post">
        ...
        <div id="sort-file-list" class="row cover-grid">
            <c:forEach items="${fileBeanList}" var="fileBean">
                <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 cover-object" data-file-id="<c:out value="${fileBean.fileId}"/>" data-name="<c:out value="${fileBean.name}"/>">
                    <a class="thumbnail">
                        <img class="" src="<%= FILE_PATH %>/${fileBean.articleId}/${fileBean.fileId}_300.jpg" style="">
                    </a>
                    <p class="">
        ...
        <div class="form-actions">
            <a class="btn btn-default pull-left" href="<c:url value="/admin/music/${articleBean.articleId}/booklet/upload"/>">
