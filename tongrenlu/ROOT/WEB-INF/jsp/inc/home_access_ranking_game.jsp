...
<div class="">
    <div class=""><h3>游戏浏览排<span style="color:#cc0000;">行</span></h3></div>
    <ul class="media-list">
        <c:forEach items="${access10Game}" var="articleBean" varStatus="status">
            <c:if test="${status.index lt 5}">
                <li class="media">
                    <a href="<c:url value="/game/${articleBean.articleId}"/>" 
