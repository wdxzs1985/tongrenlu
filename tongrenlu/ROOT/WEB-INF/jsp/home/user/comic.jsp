            ...
            <c:if test="${!empty page.items}">
                ...
                <ul class="pagination visible-xs visible-sm clearfix">
                    ...
                    <li class="<c:if test="${page.page eq status.count}">active</c:if>">
	                    <a href="<c:url value="/user/${userBean.userId}/comic?page=${status.count}"/>"><c:out value="${status.count}"/></a>
	                </li>
	                </c:forEach>
                </ul>
...
$(function() {
    $("#jpaginate").paginate({
        count       : <c:out value="${page.pagenum}"/>,
        ...
        onChange                : function (currval){
            window.location.href = '<c:url value="/user/${userBean.userId}/comic"/>?page=' + currval;
            return false;
        }
    });
});
